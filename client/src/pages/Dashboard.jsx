...
const Dashboard = () => {
  ...
  const handleLogout = () => {
    // FIXED: Clear interval and redirect to login
  ...
  useEffect(() => {
    ...
    // FIXED: Listener for global auth expiry from client.js if desired
    const handleAuthExpiry = () => handleLogout();
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <footer className="text-center text-slate-500 text-sm">
        ...
        <p className="mt-1 italic">Token expires in 60 seconds. Fixed version: Clears session on 401.</p>
      </footer>
    </div>
  );
};
